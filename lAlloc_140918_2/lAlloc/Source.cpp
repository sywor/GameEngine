...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	//AllocationManager defaultAMgr;
	//defaultAMgr.numberOfThread = 0;
	//defaultAMgr.lifeTimeMin = 1;
	//defaultAMgr.lifeTimeMax = 1;
	//defaultAMgr.sizeMin = 1;
	//defaultAMgr.sizeMax = 1;
	//defaultAMgr.allocationsPerFrameMin = 1;
	//defaultAMgr.allocationsPerFrameMax = 1;
	//defaultAMgr.allocatorSize = 512;
	//allocationManagers.push_back(defaultAMgr);
